    ...
    <div styleName="work">
        <div styleName="sfix" href="https://www.stitchfix.com/">
            ...
            <p styleName="p">
                ...
                , we built a Node.js static site using Jekyll. Later, my team grew and began focusing on a customized
                static react app/rails server. During this time I led and broke down both internal and external facing
                projects using&nbsp;Jira.
            </p>
        </div>
        <img styleName="sfix-logo" src="./images/sfix_logo.png" />
        <div styleName="ft" href="https://www.flashtalking.com/">
            ...
            <p styleName="p">
                ...
                industry, I worked mostly with CSS and JavaScript frameworks such as&nbsp;
        ...
        <img styleName="ft-logo" src="./images/ft_logo.png" />
    </div>
);
