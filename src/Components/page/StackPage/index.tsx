...
const StackPage = () => {
  ...
  const [piecePosition, setPiecePosition] = useState({ x: Math.floor((BOARD_WIDTH - technologies[0].width) / 2), y: 0 });
    ...
    <PageContent>
      <div styleName="stackContainer">
        ...
        <div styleName="controls">
          ...
          {!showList && (
            <>
              <button styleName="controlBtn" onClick={showEndState}>Sort Proficiency</button>
              <button styleName="controlBtn" onClick={reset}>Reset Game</button>
          ...
          <>
            {gameActive && currentPiece < technologies.length && (
              <div styleName="gameInfo">
                ...
                <p>Dropping: <strong>{technologies[currentPiece].name}</strong></p>
              </div>
            )}
                ...
                >
                  ...
                  {gameActive && 
                   ...
                   colIndex < piecePosition.x + technologies[currentPiece].width && (
                    ...
                    >
                      {colIndex === piecePosition.x && (
                        <span styleName="cellText">{technologies[currentPiece].name}</span>
                      )}
                    </div>
                  )}
                </div>
