...
class HomePage extends Component {
    render() {
        return (
            <div styleName="page">
                <p>
                    Hi there 👋, Logan here. Yes, “Cool” is my real last name, and no, I did not change it to that. If
                    you have ever met me, I consider myself as a very positive person who loves music, travelling, and
                    being outside. I moved to the bay area about 5 years ago from a beautiful farm up in Canada...eh? I
                    have always loved technology, and have been lucky enough/been told to have an eye for detail. I love
                ...
                <p>
                    ...
                    tests for our Conversion team. Alongside another engineer and partnership of Carbon 5, we built a
                    Node.js static site built with Jekyll. Later, my team grew and began focusing on a customized static
                    react app/rails server. During this time I led and broke down both internal and external facing
                    projects using Jira.
                </p>
